...
for idobjeto , tupla in estructura_base.items():
    oblongdic = 0
    ...
    for listas_pequenas in tupla: 
        for numero in listas_pequenas: 
        ...
        oblongos[idobjeto] = oblongdic
        perfectos[idobjeto] = perfectosdic
        promedio.append ((oblongdic + perfectosdic)/ contador )

    for idobjetos in estructura_base.keys():
        i = 0 
        print (f"""
        Cantidad de oblongos: {oblongos[idobjeto]}
        cantidad de perfectos: {perfectos[idobjeto]}
        promedio: {promedio[i]}""")
